...
public class BookingController {
	...
	public String proceedToPayment(HttpServletRequest request, Model model) {
		...
		bookingService.setPassengerDetialisToTemperoryTable(userId, date, routeId, departure, destination, tripId,
				busId, busType, passengerNames, passengerAges, passengerIds);
