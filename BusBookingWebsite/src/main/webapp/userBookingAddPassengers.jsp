		...
		<p>
			<c:forEach var="i" begin="1" end="${userTickets }">
				<p>
					...
					<c:out value="${i}" />
				<p>
					Name <input type="text" name="passengerName" placeholder="Name"
						required> Age<input type="number" min="0" name="passengerAge"
						placeholder="Age" required> Id Proof No.<input type="text"
						name="passengerId" placeholder="ID" required>
			</c:forEach>
		<p>*passengers must carry original ID proof during journey.
		<p>
			<input type="submit" value="Add Passengers"> <input
				...
				type="hidden" name="userTickets" value=${userTickets }>
	</form>
