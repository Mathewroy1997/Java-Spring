...
<body>
		...
		<c:forEach var="route" items="${routeDetailsList}">
			...
			<tr>
				...
				<td><form action="deleteRouteDetails" method="post">
						<input type="submit" value="Delete Route"> <input
							type="hidden" name="routeId" value=${route.routeId }>
					</form></td>
			</tr>
	...
	<form action="addNewRouteDetails" method="post">
		...
		Distance<input type="number" min="0" name="totalKm" required> <input
			type="submit" value="Add Route">
	</form>
