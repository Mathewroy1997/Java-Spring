...
<tr><th>Bus ID</th><th>Bus Category</th><th>Rate/Km</th><th>Total Seats</th><th>Action</th></tr>  
  ...
  Rate per Km:<input type="text" name="ratePerKm" required> 
  Total Seats: <input type="text" name ="seats" required> 
   <br>
